...
document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("http://94.136.190.129:3000/fetchPurchaseid")
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      fetch(
        "http://94.136.190.129:3000/purchaseproductData/productBata/" +
...
document
  ...
  .addEventListener("submit", async function (event) {
    ...
    var formData = {
      ...
      total_quantity: parseFloat(parseFloat(document.getElementById("total").value).toFixed(2)) || 0,
    ...
    await fetch("http://94.136.190.129:3000/purchaseData/insertPurchase", {
      method: "POST",
      headers: {
