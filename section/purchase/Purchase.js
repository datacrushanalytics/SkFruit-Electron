...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://3.108.215.177/fetchPurchaseid')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            fetch('http://3.108.215.177/purchaseproductData/' + (parseInt(data[0]['num']) + 1))
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    // fetch('http://3.108.215.177/list/Supplier')
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
    ...
    // fetch('http://3.108.215.177/productData/')
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
    ...
    // fetch('http://3.108.215.177/vehicleData')
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
...
function deleteUser(userId) {
    ...
    fetch('http://3.108.215.177/purchaseproductData/deleteproductId/' + userId, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
...
// function form2(){
    ...
    await fetch('http://3.108.215.177/purchaseData/insertPurchase', {
        method: 'POST',
        headers: {
