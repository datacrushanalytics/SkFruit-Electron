...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://skfruit-backend.onrender.com/fetchPurchaseid')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            fetch('http://skfruit-backend.onrender.com/purchaseproductData/' + (parseInt(data[0]['num']) + 1))
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    // fetch('http://skfruit-backend.onrender.com/productData/')
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
...
function deleteUser(userId) {
    ...
    fetch('http://skfruit-backend.onrender.com/purchaseproductData/deleteproductId/' + userId, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
...
// function form2(){
    ...
    await fetch('http://skfruit-backend.onrender.com/purchaseData/insertPurchase', {
        method: 'POST',
        headers: {
