async function insertSale() {
  ...
  const formData = {
    ...
    amount: parseFloat(document.getElementById("bill1").value) || 0,
    carate_amount: parseFloat(document.getElementById("total1").value) || 0,
    pre_balance:
      parseFloat(document.getElementById("previousBalance").value) || 0,
    total_amount: parseFloat(document.getElementById("totalBill").value) || 0,
    cash: parseFloat(document.getElementById("bill_cash").value) || 0,
    online_acc: document.getElementById("onlineAcc").value.trim(),
    online_amt: parseFloat(document.getElementById("online").value) || 0,
    discount: parseFloat(document.getElementById("discount").value) || 0,
    inCarate: parseInt(document.getElementById("total2").value) || 0,
    balance: parseFloat(document.getElementById("baki").value) || 0,
