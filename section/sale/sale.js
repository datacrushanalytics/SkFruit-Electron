...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://13.126.106.17/fetchSaleid')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            fetch('http://13.126.106.17/saleproductData/' + (parseInt(data[0]['num']) + 1))
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    // fetch('http://13.126.106.17/saleproductData/' +)
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
...
function deleteUser(userId) {
    ...
    fetch('http://13.126.106.17/saleproductData/deletesaleproduct/' + userId, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
...
function getProducts() {
    ...
    console.log(bataId)
    fetch('http://13.126.106.17/purchaseproductData/getBataProduct/' + bataId)
    ...
    fetch('http://13.126.106.17/fetchStock/' + bataId)
        .then(response => response.json())
        .then(data => {
...
function getCust() {
    ...
    console.log(number)
    fetch('http://13.126.106.17/fetchName/mobile/' + number)
        .then(response => response.json())
        .then(data => {
...
//     console.log(name)
//     fetch('http://13.126.106.17/fetchName/name/' + name)
//         .then(response => response.json())
//         .then(data => {
//             console.log(data[0].name)
//             // Get the Select2 dropdown element
