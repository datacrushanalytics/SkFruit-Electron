...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://65.0.32.172/fetchSaleid')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            fetch('http://65.0.32.172/saleproductData/' + (parseInt(data[0]['num']) + 1))
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    // fetch('http://65.0.32.172/saleproductData/' +)
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
    ...
    // fetch('http://65.0.32.172/list/Bank Account')
    //     .then(response => {
    //         if (!response.ok) {
    //             throw new Error('Network response was not ok');
    //         }
...
function deleteUser(userId) {
    ...
    fetch('http://65.0.32.172/saleproductData/deletesaleproduct/' + userId, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
...
function getProducts() {
    ...
    console.log(bataId)
    fetch('http://65.0.32.172/purchaseproductData/getBataProduct/' + bataId)
    ...
    fetch('http://65.0.32.172/fetchStock/' + bataId)
        .then(response => response.json())
        .then(data => {
...
function getCust() {
    ...
    console.log(number)
    fetch('http://65.0.32.172/fetchName/mobile/' + number)
        .then(response => response.json())
        .then(data => {
...
//     console.log(name)
//     fetch('http://65.0.32.172/fetchName/name/' + name)
//         .then(response => response.json())
//         .then(data => {
//             console.log(data[0].name)
//             // Get the Select2 dropdown element
