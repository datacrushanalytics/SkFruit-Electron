...
function fetchDataAndProcess() {
  ...
  return fetch("http://192.168.1.19:3000/receiptReport", {
    method: "POST",
...
function populateTable4(data) {
  ...
  var counter = 1;
  var isAdmin =
    JSON.parse(localStorage.getItem("sessionData"))[0].usertype === "Admin";
  var isSuperAdmin =
...
function deleteaccount(userId) {
  ...
  fetch(
    "http://192.168.1.19:3000/receiptReport/deleteReceiptReport/" + userId,
    {
      method: "DELETE",
    }
  )
...
async function exportToExcel() {
  try {
    ...
    return fetch("http://192.168.1.19:3000/receiptReport/generate-pdf", {
      method: "POST",
      body: JSON.stringify(data),
      headers: {
        "Content-Type": "application/json",
