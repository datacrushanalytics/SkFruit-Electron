...
function saleProduct(num) {
  ...
  fetch("http://localhost:3000/saleproductData/" + num)
    .then((response) => {
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
...
function getProducts() {
  ...
  fetch("http://localhost:3000/fetchStock/" + bataId)
    ...
    .then((data) => {
      ...
      nagLabel.innerHTML =
        "नग: (Remaining : " + data[0].closing + " " + data[0].unit + ")";
...
function updateTotal() {
  if (
    document.getElementById("nag").value > document.getElementById("nag1").value
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
...
function updateRowTotal(inputElement) {
  ...
  var availableInventory = availableInventoryElement
    ? parseInt(availableInventoryElement.value, 10) || 0
    : 0;
...
function updateTotal() {
  if (
    parseInt(document.getElementById("nag").value) >
    parseInt(document.getElementById("nag1").value)
  ) {
...
function previousbalance() {
  ...
  fetch("http://localhost:3000/carateuserData/" + name)
    ...
    .then((data) => {
      // Populate dropdown with API data
      console.log(data);
      document.getElementById("carate2100").value = parseInt(
        data[0]["carate_100"]
      );
      document.getElementById("carate2150").value = parseInt(
        data[0]["carate_150"]
      );
      document.getElementById("carate2250").value = parseInt(
        data[0]["carate_250"]
      );
      document.getElementById("carate2350").value = parseInt(
        data[0]["carate_350"]
      );
      document.getElementById("carate22100").value = parseInt(
        data[0]["carate_100"]
      );
      document.getElementById("carate22150").value = parseInt(
        data[0]["carate_150"]
      );
      document.getElementById("carate22250").value = parseInt(
        data[0]["carate_250"]
      );
      document.getElementById("carate22350").value = parseInt(
        data[0]["carate_350"]
      );
    })
    .catch((error) => {
...
function carate() {
  ...
  var value44100 = parseInt(document.getElementById("carate44100").value) || 0;
  var value44150 = parseInt(document.getElementById("carate44150").value) || 0;
  var value44250 = parseInt(document.getElementById("carate44250").value) || 0;
  var value44350 = parseInt(document.getElementById("carate44350").value) || 0;
  var value55100 = parseInt(document.getElementById("carate55100").value) || 0;
  var value55150 = parseInt(document.getElementById("carate55150").value) || 0;
  var value55250 = parseInt(document.getElementById("carate55250").value) || 0;
  var value55350 = parseInt(document.getElementById("carate55350").value) || 0;
  ...
  document.getElementById("carate2100").value =
    parseInt(document.getElementById("carate22100").value) +
    value100 - value44100 - 
    value1100 + value55100;
  document.getElementById("carate2150").value =
    parseInt(document.getElementById("carate22150").value) +
    value150 - value44150 -
    value1150 + value55150;
  document.getElementById("carate2250").value =
    parseInt(document.getElementById("carate22250").value) +
    value250 - value44250 -
    value1250 + value55250;
  document.getElementById("carate2350").value =
    parseInt(document.getElementById("carate22350").value) +
    value350 - value44350 -
    value1350 + value55350;
  totalbill();
  totalBalance();
...
function carate1() {
  ...
  if (
    parseInt(document.getElementById("carate1100").value) >
    parseInt(document.getElementById("carate22100").value) +
      parseInt(document.getElementById("carate100").value || 0)
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
  ...
  if (
    parseInt(document.getElementById("carate1150").value) >
    parseInt(document.getElementById("carate22150").value) +
      parseInt(document.getElementById("carate150").value || 0)
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
  ...
  if (
    parseInt(document.getElementById("carate1250").value) >
    parseInt(document.getElementById("carate22250").value) +
      parseInt(document.getElementById("carate250").value || 0)
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
  ...
  if (
    parseInt(document.getElementById("carate1350").value) >
    parseInt(document.getElementById("carate22350").value) +
      parseInt(document.getElementById("carate350").value || 0)
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
