async function insertSale() {
  ...
  var formData = {
    ...
    amount: parseFloat(parseFloat(document.getElementById("bill1").value).toFixed(2)) || 0,
    carate_amount: parseFloat(parseFloat(document.getElementById("total1").value).toFixed(2)) || 0,
    pre_balance:
      parseFloat(parseFloat(document.getElementById("previousBalance").value).toFixed(2)) || 0,
    total_amount: parseFloat(parseFloat(document.getElementById("totalBill").value).toFixed(2)) || 0,
    ...
    online_amt: parseFloat(parseFloat(document.getElementById("online").value).toFixed(2)) || 0,
    discount: parseFloat(parseFloat(document.getElementById("discount").value).toFixed(2)) || 0,
    inCarate: parseFloat(parseFloat(document.getElementById("total2").value).toFixed(2)) || 0,
    balance: parseFloat(parseFloat(document.getElementById("baki").value).toFixed(2)) || 0,
  ...
  try {
    const response = await fetch(
      "http://localhost:3000/saleData/updateSale/" + formData.bill_no,
      {
        method: "PUT",
        headers: {
