...
function fetchDataAndProcess() {
  ...
  return fetch("http://192.168.1.19:3000/carateReport", {
    method: "POST",
...
function populateTable4(data) {
  ...
  if (document.getElementById("customer").value !== "") {
    fetch(
      "http://192.168.1.19:3000/carateuserData/" +
    ...
    fetch(
      "http://192.168.1.19:3000/carateuserData/route/" +
    ...
    fetch("http://192.168.1.19:3000/carateuserData")
      .then((response) => {
        if (!response.ok) {
          loader.style.display = "none";
          throw new Error("Network response was not ok");
...
async function exportToExcel() {
  try {
    ...
    return fetch("http://192.168.1.19:3000/carateReport/generate-pdf", {
      method: "POST",
      body: JSON.stringify(data),
      headers: {
        "Content-Type": "application/json",
