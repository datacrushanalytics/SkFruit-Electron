...
function populateTable4(data) {
    ...
    totalCell.colSpan = columnsToDisplay.length - 2; // Adjusting for the delete button column and one extra cell
    totalCell.textContent = 'Grand Total:';

    // Add empty cells for Bill Amount and Total Quantity columns
    totalRow.insertCell();
    totalRow.insertCell();
    
    // Add cell for Grand Total
    var grandTotalCell = totalRow.insertCell();
    grandTotalCell.textContent = data.Grand['Grand Amournt'];
