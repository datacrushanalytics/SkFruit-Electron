...
function fetchDataAndProcess() {
  ...
  if (isChecked) {
    var url = "http://192.168.1.19:3000/profitLossReport/undetail";
  } else {
    var url = "http://192.168.1.19:3000/profitLossReport/detail";
  }
...
async function exportToExcel() {
  try {
    ...
    return fetch("http://192.168.1.19:3000/profitLossReport/generate-pdf", {
      method: "POST",
      body: JSON.stringify(data),
      headers: {
        "Content-Type": "application/json",
