...
function fetchDataAndProcess() {
  ...
  if (isChecked) {
    var url = "http://192.168.1.19:3000/routewiseSaleReport/undetail";
    ...
    var url = "http://192.168.1.19:3000/routewiseSaleReport/detail";
...
function deleteRecord(bill_no) {
  fetch(`http://192.168.1.19:3000/fetchData/saleProduct/${bill_no}`, {
    method: "GET",
  })
    .then((response) => {
      if (!response.ok) {
  ...
  fetch(`http://192.168.1.19:3000/saleData/deletesaleId/${bill_no}`, {
    method: "DELETE",
  })
    .then((response) => {
      if (!response.ok) {
...
function openPopup(item) {
  ...
  fetch("http://192.168.1.19:3000/saleproductData/" + String(item.bill_no))
...
async function exportToExcel() {
  try {
    ...
    return fetch(
      "http://192.168.1.19:3000/routewiseSaleReport/generate-pdf",
      {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
