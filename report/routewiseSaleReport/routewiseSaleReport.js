...
async function exportToExcel() {
    try {
        ...
        reportData.push([
            '', 'Grand Total', grandTotals.amount.toFixed(2),
            grandTotals.carate_amount.toFixed(2),
            grandTotals.pre_balance.toFixed(2),
            grandTotals.total_amount.toFixed(2),
            grandTotals.online_amt.toFixed(2),
            grandTotals.discount.toFixed(2),
            grandTotals.inCarat.toFixed(2),
        ...
        doc.autoTable({
            head: [customHeaders],
            body: reportData,
            startY: startY + 10, // Start table below the last text
            theme: 'grid',
        }); 
