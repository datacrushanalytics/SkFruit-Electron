...
//     fetch('http://skfruit-backend.onrender.com/batawiseSaleReport', {
//         method: 'POST',
...
function fetchDataAndProcess() {
    ...
    return fetch('http://skfruit-backend.onrender.com/batawiseSaleReport', {
        method: 'POST',
        body: JSON.stringify(data),
        headers: {
            'Content-Type': 'application/json'
...
function openModal(item) {
    ...
    fetch('http://skfruit-backend.onrender.com/bill/' + item.bill_id)
        .then(response => {
            if (!response.ok) {
                throw new Error('Network response was not ok');
            }
